...
class TestGraphCircuitMethods(unittest.TestCase):
    def setUp(self):
        ...
        g = self.graph
        i1 = g.add_vertex(
            VertexType.BOUNDARY, 0, 0
        )  # add_vertex(type,qubit_index,row_index,phase=0)
...
test_graph = {
    "node_vertices": {
        "v0": {
            "annotation": {"coord": [1.0, -1.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v1": {"annotation": {"coord": [2.0, -1.0]}, "data": {"type": "Z"}},
        "v10": {"annotation": {"coord": [6.0, -2.0]}, "data": {"type": "X"}},
        "v11": {"annotation": {"coord": [7.0, -2.0]}, "data": {"type": "Z"}},
        "v12": {
            "annotation": {"coord": [2.0, -2.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v13": {"annotation": {"coord": [3.0, -2.0]}, "data": {"type": "Z"}},
        "v14": {
            "annotation": {"coord": [4.0, -2.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v15": {"annotation": {"coord": [11.0, -1.0]}, "data": {"type": "Z"}},
        "v16": {
            "annotation": {"coord": [2.0, -3.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi/2"},
        },
        "v17": {
            "annotation": {"coord": [3.0, -3.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi/2"},
        },
        "v18": {
            "annotation": {"coord": [4.0, -3.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi/2"},
        },
        "v19": {
            "annotation": {"coord": [6.0, -3.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi/2"},
        },
        "v2": {"annotation": {"coord": [3.0, -1.0]}, "data": {"type": "Z"}},
        "v20": {
            "annotation": {"coord": [7.0, -3.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi/2"},
        },
        "v21": {
            "annotation": {"coord": [8.0, -3.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi/2"},
        },
        "v22": {
            "annotation": {"coord": [9.0, -4.15]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi"},
        },
        "v23": {
            "annotation": {"coord": [10.0, -3.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi"},
        },
        "v24": {
            "annotation": {"coord": [11.0, -3.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi"},
        },
        "v25": {
            "annotation": {"coord": [13.0, -3.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi"},
        },
        "v26": {
            "annotation": {"coord": [16.0, -3.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi"},
        },
        "v27": {
            "annotation": {"coord": [3.0, -4.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi"},
        },
        "v28": {
            "annotation": {"coord": [6.0, -4.0]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi"},
        },
        "v29": {"annotation": {"coord": [6.0, -5.0]}, "data": {"type": "Z"}},
        "v3": {"annotation": {"coord": [4.0, -1.0]}, "data": {"type": "Z"}},
        "v30": {"annotation": {"coord": [7.0, -5.0]}, "data": {"type": "X"}},
        "v31": {"annotation": {"coord": [8.0, -5.0]}, "data": {"type": "Z"}},
        "v32": {
            "annotation": {"coord": [9.75, -4.975]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v33": {
            "annotation": {"coord": [2.0, -5.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v34": {"annotation": {"coord": [3.0, -5.0]}, "data": {"type": "Z"}},
        "v35": {
            "annotation": {"coord": [4.0, -5.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v36": {
            "annotation": {"coord": [1.0, -6.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v37": {"annotation": {"coord": [6.0, -6.0]}, "data": {"type": "Z"}},
        "v38": {"annotation": {"coord": [7.0, -6.0]}, "data": {"type": "Z"}},
        "v39": {"annotation": {"coord": [8.0, -6.0]}, "data": {"type": "Z"}},
        "v4": {"annotation": {"coord": [6.0, -1.0]}, "data": {"type": "Z"}},
        "v40": {
            "annotation": {"coord": [1.0, -6.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v41": {"annotation": {"coord": [2.0, -6.0]}, "data": {"type": "Z"}},
        "v42": {"annotation": {"coord": [3.0, -6.0]}, "data": {"type": "Z"}},
        "v43": {"annotation": {"coord": [4.0, -6.0]}, "data": {"type": "Z"}},
        "v44": {"annotation": {"coord": [9.0, -6.0]}, "data": {"type": "Z"}},
        "v45": {"annotation": {"coord": [10.0, -6.0]}, "data": {"type": "Z"}},
        "v46": {"annotation": {"coord": [11.0, -6.0]}, "data": {"type": "Z"}},
        "v47": {"annotation": {"coord": [12.0, -1.0]}, "data": {"type": "Z"}},
        "v48": {"annotation": {"coord": [12.0, -6.0]}, "data": {"type": "Z"}},
        "v49": {"annotation": {"coord": [13.0, -2.0]}, "data": {"type": "Z"}},
        "v5": {"annotation": {"coord": [7.0, -1.0]}, "data": {"type": "Z"}},
        "v50": {"annotation": {"coord": [13.0, -5.0]}, "data": {"type": "Z"}},
        "v51": {
            "annotation": {"coord": [14.0, -2.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v52": {"annotation": {"coord": [15.0, -2.0]}, "data": {"type": "Z"}},
        "v53": {
            "annotation": {"coord": [16.0, -2.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v54": {"annotation": {"coord": [17.0, -2.0]}, "data": {"type": "Z"}},
        "v55": {"annotation": {"coord": [14.0, -5.0]}, "data": {"type": "Z"}},
        "v56": {
            "annotation": {"coord": [15.0, -5.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v57": {"annotation": {"coord": [16.0, -5.0]}, "data": {"type": "Z"}},
        "v58": {
            "annotation": {"coord": [17.0, -5.0]},
            "data": {"type": "X", "value": "\\pi"},
        },
        "v59": {"annotation": {"coord": [1.0, -2.0]}, "data": {"type": "Z"}},
        "v6": {"annotation": {"coord": [8.0, -1.0]}, "data": {"type": "Z"}},
        "v60": {"annotation": {"coord": [1.0, -5.0]}, "data": {"type": "Z"}},
        "v61": {"annotation": {"coord": [16.0, -1.0]}, "data": {"type": "Z"}},
        "v62": {"annotation": {"coord": [17.0, -6.0]}, "data": {"type": "Z"}},
        "v63": {
            "annotation": {"coord": [9.75374984741211, -4.166666793823242]},
            "data": {"is_edge": "false", "type": "hadamard", "value": "\\pi"},
        },
        "v7": {"annotation": {"coord": [9.0, -1.0]}, "data": {"type": "Z"}},
        "v8": {"annotation": {"coord": [10.0, -1.0]}, "data": {"type": "Z"}},
        "v9": {"annotation": {"coord": [5.0, -2.0]}, "data": {"type": "Z"}},
    },
    "undir_edges": {
        "e0": {"src": "v0", "tgt": "v59"},
        "e1": {"src": "v0", "tgt": "v1"},
