...
class TestScripts(unittest.TestCase):
    ...
    def test_optimize_all_options(self):
        sys.stdout = io.StringIO()
        main(
            "fakepath opt -d tests/other_name.bla -t qc -g cliff tests/test_circuit.circuit".split()
        )
...
if __name__ == "__main__":
    print(
        "Please only run this file as a collection of all tests, and with the working directory set to the parent directory."
    )
